...
public class EntityTFWinterWolf extends EntityTFHostileWolf implements IBreathAttacker
{
	...
	public int getAttackStrength(Entity victim)
	{
		...
		// return 6;
		return MathHelper.floor_float(BalanceConfig.winterWolfDamage);
	...
	public boolean attackEntityAsMob(Entity victim)
	{
		...
		return victim.attackEntityFrom(DamageSource.causeMobDamage(this), (float) damage);
	}
	...
	public void onLivingUpdate()
	{
		...
		if (this.isBreathing())
		{
			...
			double py = this.posY + 1.25D + look.yCoord * dist;
	...
	protected boolean isValidLightLevel()
	{
		...
		return this.worldObj.getBiomeGenForCoords(x, z) == TFBiomeBase.tfSnow || super.isValidLightLevel();
	}
